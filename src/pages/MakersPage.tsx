      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 items-stretch">
          {makers.map((maker) => (
            ...
            >
              <Link to={`/profile/${maker.username}`} className="block w-full h-full">
                <div className="w-full h-full bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 sm:p-6 hover:border-orange-500/30 dark:hover:border-orange-500/30 transition-all duration-200">
